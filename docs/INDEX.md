...
| ไฟล์ | เนื้อหา |
|------|---------|
| `docs/handoff-2026-07-09-nrr-v14-fixes.md` | **Latest — nrr_v14** — เลขคอมมิชชั่นเต็ม, breakdown เต็มความกว้าง, drill-down ครบ NRR/expansion/handover/P1/P3/gate, stale-CSV banner (พบ admin_view.csv ค้าง Q2) |
