...
mar_cohort AS (
  SELECT mo.outlet_id, mo.account_id, mo.account_name, mo.res_name, mo.account_type,
    CASE
      WHEN mUPPER(TRIM(o.commercial_owner)) = 'PM' THEN mo.commercial_owner
      ELSE 'PM'
  ...
  WHERE (
    mUPPER(TRIM(o.commercial_owner)) = 'PM'
    OR (
...
apr_rows AS (
  ...
  WHERE aUPPER(TRIM(o.commercial_owner)) = 'PM'
...
may_rows AS (
  ...
  WHERE mUPPER(TRIM(o.commercial_owner)) = 'PM'
...
jun_rows AS (
  ...
  WHERE jUPPER(TRIM(o.commercial_owner)) = 'PM'
