...
`;
  ...
  function _minimize() {
    ...
    // Update topbar: left button becomes minimize when recording
    ...
    if (_tbIcon) _tbIcon.textContent = '↓';
  }
...
<div id="ci-s-record" class="scr on">
  <div class="topbar">
    <span class="tb-act" id="ci-topbar-left" onclick="(_phase==='recording')?CI._minimize():CI.cancel()" style="display:flex;align-items:center;gap:4px;">
