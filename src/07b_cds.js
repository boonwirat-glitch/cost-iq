...
(function(){
  ...
  function buildCompactStrip(){
    ...
    return '<div class="pv-comm-strip '+cls+'" data-v210k="1">'
      ...
      +'<div class="pv-comm-btn-group">'
      +'<button class="pv-comm-btn-group-item" title="รายละเอียด commission" onclick="event.stopPropagation();_commOpenKamSelfSheet();">i</button>'
      +'<div class="pv-comm-btn-group-div"></div>'
      +'<button class="pv-comm-btn-group-item" title="ประวัติ commission" onclick="event.stopPropagation();if(typeof openCommissionHistory===\'function\')openCommissionHistory();">'
