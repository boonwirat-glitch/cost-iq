...
function nrrWaiverRowHtml(r, isAdmin) {
  ...
  var lockedNote = '<div class="micro" style="color:var(--warn-text);background:var(--warn-dim);' +
    'border:1px solid var(--warn-border);border-radius:8px;padding:6px 9px;margin-top:6px;line-height:1.45">' +
    'เดือน ' + nrrEsc(monthLabel) + ' Lock แล้ว — ตัดสินได้ แต่<b>ยอดที่ล็อกไว้จะยังไม่เปลี่ยน</b> ' +
    'จนกว่าจะไปกด “คำนวณ %NRR ใหม่” ที่ Sense › Commission Cockpit › Lock</div>';
  var actions = '';
