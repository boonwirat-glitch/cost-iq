...
function nrrSlideoverVisibleOutlets() {
  ...
  return nrrSlideoverOutlets.filter(function (o) {
    ...
    if (st.churnAgeFilter && st.churnAgeFilter !== 'all') {
      var _split = _nrrSlideoverChurnSplit();
      if (_split && _nrrChurnAge(o.row, st.period, _split.prevIdx) !== st.churnAgeFilter) return false;
    }
    if (st.search) {
